...
try:
    ...
    if(dbcon):
        cursor=dbcon.cursor()
        existsquery="select * from tbl_register where username='%s' and password='%s' and mobile_number='%s' and email_id='%s' and usertype='%s'"%(uname,email,mobilenumber,password,usertype)
