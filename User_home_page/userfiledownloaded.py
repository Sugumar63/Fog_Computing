...
try:
    ...
    if(dbcon):
        ...
        print("<li><a class='page-scroll' href='usereditprofile.py?sname=%s&stype=%s'>My profile</a></li>"%(sessname,sesstype))
        ...
        query2="select fileid,fileowner,filename,downloadedon from tbl_download where userid=%d and username='%s'"%(int(userid),sessname)
